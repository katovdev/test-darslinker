        ...
        {step === "phone" ? (
          <form onSubmit={handleRequestOtp} className="space-y-4">
            <div className="space-y-2">
              <label htmlFor="phone" className="text-sm font-medium text-gray-300">{t("auth.phone")}</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-700 bg-gray-900/50 py-3 pl-[5.5rem] pr-4 text-white placeholder-gray-500 outline-none transition-colors focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                  autoComplete="tel"
                  autoFocus
                />
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl bg-green-500/10 border border-green-500/20 p-3 text-center">
              <p className="text-sm text-green-400">{t("auth.otpSentToTelegram")}</p>
            </div>
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-4">
              <div className="space-y-2">
                <input
                  ...
                  className="w-full rounded-xl border border-gray-700 bg-gray-900/50 py-3 text-center text-lg tracking-widest text-white placeholder-gray-500 outline-none transition-colors focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                  maxLength={6}
