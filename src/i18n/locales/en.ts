...
export const en: Translations = {
  ...
  dashboard: {
    ...
    adminSubtitle: "Manage your platform from here",
    welcomeModerator: "Welcome, Moderator",
    moderatorSubtitle: "Review and moderate content",
    welcomeTeacher: "Welcome back, {name}!",
    teacherSubtitle: "Let's make learning awesome",
  ...
  teacher: {
    ...
    // Earnings page
    earningsLoadError: "Failed to load earnings",
    earningsTitle: "My Earnings",
    earningsSubtitle: "Track your earnings",
    earningsByCourse: "Earnings by Course",
    noEarningsYet: "No earnings yet",
    // Courses page
    coursesLoadError: "Failed to load courses",
    draft: "Draft",
    active: "Active",
    archived: "Archived",
    free: "Free",
    ...
    coursesSubtitle: "Manage your courses",
    searchCourses: "Search courses...",
    allStatuses: "All Statuses",
    editCourse: "Edit Course",
    // Students page
    studentsLoadError: "Failed to load students",
    studentsTitle: "My Students",
    studentsSubtitle: "Manage your students",
    completed: "Completed",
    enrolledOn: "Enrolled",
    // Payments page
  ...
  admin: {
    ...
    // Settings page
    settings: "Settings",
    settingsSubtitle: "Manage platform settings",
    ...
    registrationEnabledDesc: "New users can register",
    teachersLoadError: "Failed to load teachers",
    teacherLoadError: "Failed to load teacher settings",
    teacherSaved: "Teacher settings saved",
    teacherSaveError: "Failed to save teacher settings",
    editSettings: "Edit Settings",
    editTeacherPage: "Edit Teacher Page",
    pageSeo: "Page SEO",
    ...
    showCoursesCount: "Show Courses Count",
    showStudentsCount: "Show Students Count",
  ...
  assignment: {
    ...
    enterGrade: "Enter grade (0-{maxScore})",
    enterFeedback: "Enter feedback (optional)",
    submitGrade: "Submit Grade",
    gradingSuccess: "Assignment graded successfully",
  ...
  achievement: {
    ...
    firstCourseDesc: "Created your first course",
    tenCourses: "Course Creator",
    tenCoursesDesc: "Created 10 courses",
    hundredStudents: "Popular Teacher",
    hundredStudentsDesc: "Reached 100 students",
    thousandStudents: "Master Educator",
    thousandStudentsDesc: "Reached 1,000 students",
    tenKRevenue: "Revenue Master",
    tenKRevenueDesc: "Earned $10,000+",
    highRating: "Highly Rated",
    highRatingDesc: "4.8+ rating with 50+ reviews",
    topInstructor: "Top Instructor",
    topInstructorDesc: "Maintain 4.5+ rating",
    fiftyReviews: "Review Magnet",
    fiftyReviewsDesc: "Received 50 reviews",
    perfectScore: "Perfect Score",
    perfectScoreDesc: "Have a course with 5.0 rating",
    earlyAdopter: "Early Adopter",
    earlyAdopterDesc: "Joined in the first month",
  },
