...
export const ru: Translations = {
  ...
  home: {
    ...
    heroSubtitle:
      "Создавайте курсы, управляйте учениками и увеличивайте доход",
    getStarted: "Начать",
    watchVideo: "Смотреть видео",
    featuresTitle: "Возможности платформы",
    featuresSubtitle: "Наша платформа предоставляет все необходимые инструменты",
    ...
    featureCoursesDesc: "Создавайте и управляйте неограниченным количеством курсов",
