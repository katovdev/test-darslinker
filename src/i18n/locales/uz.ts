...
export const uz: Translations = {
  ...
  home: {
    ...
    featurePayments: "To'lov tizimi",
    featurePaymentsDesc: "To'lovlarni Uzcard, Humo orqali avtomatlashtiring",
    ...
    contactPhone: "Raqamingiz",
    contactMessage: "Xabaringiz",
    contactMessagePlaceholder: "Mavzu haqida qisqacha...",
  ...
  notifications: {
    ...
    deleteAllRead: "Barchasini o'chirish",
    ...
    assignmentSubmitted: "Topshiriq yuborildi",
    newAssignment: "Yangi topshiriq",
    newLesson: "Yangi dars",
    courseUpdate: "Kurs yangilandi",
    ...
    certificateIssued: "Sertifikat berildi",
    lessonCompleted: "Dars tugallandi",
    quizPassed: "Testdan o'tdingiz",
    quizFailed: "Testdan o'tolmadingiz",
    certificateReady: "Sertifikat tayyor",
    achievementUnlocked: "Yutuq ochildi",
    messageReceived: "Xabar keldi",
    reviewPosted: "Sharh qoldirildi",
    systemAnnouncement: "Tizim xabari",
    general: "Umumiy",
    justNow: "Hozirgina",
    minutesAgo: "{minutes}d oldin",
  ...
  assignment: {
    ...
    uploadFile: "Ishingizni yuklang",
    dragDrop: "Faylni bu yerga torting yoki tanlash uchun bosing",
    viewSubmissions: "Yuborilganlarni ko'rish",
    gradeAssignment: "Topshiriqni baholash",
    noSubmissions: "Hali yuborilganlar yo'q",
    attachments: "Qo'shimchalar",
    submitAssignment: "Topshiriqni yuborish",
    resubmitRequested: "Qayta yuborish so'ralgan",
    notSubmitted: "Yuborilmagan",
    graded: "Baholandi",
    pending: "Baholanmoqda",
    downloadSubmission: "Yuborilganni yuklab olish",
    enterGrade: "Bahoni kiriting (0-{maxScore})",
    enterFeedback: "Fikr-mulohaza kiriting (ixtiyoriy)",
    submitGrade: "Bahoni yuborish",
    gradingSuccess: "Topshiriq muvaffaqiyatli baholandi",
    submissionSuccess: "Topshiriq muvaffaqiyatli yuborildi",
    overdue: "Muddati o'tgan",
    daysLeft: "{days} kun qoldi",
    updateSubmission: "Yuborilganni yangilash",
  },
  fileLesson: {
    title: "Fayl resursi",
    ...
    dragDrop: "Faylni bu yerga torting yoki tanlash uchun bosing",
    allowedTypes: "Ruxsat etilgan turlar: {types}",
    maxSize: "Maksimal hajm: {size}",
    description: "Tavsif",
    preview: "Ko'rib chiqish",
    noPreview: "Ushbu fayl turi uchun ko'rib chiqish mavjud emas",
  },
  achievement: {
    title: "Yutuq",
    achievements: "Yutuqlar",
    ...
    legendary: "Afsonaviy",
    firstCourse: "Birinchi kurs",
    firstCourseDesc: "Birinchi kursingizni yaratdingiz",
    tenCourses: "Kurs yaratuvchi",
    tenCoursesDesc: "10 ta kurs yaratdingiz",
    hundredStudents: "Mashhur o'qituvchi",
    hundredStudentsDesc: "100 ta o'quvchiga yetdingiz",
    thousandStudents: "Ustoz pedagog",
    thousandStudentsDesc: "1,000 ta o'quvchiga yetdingiz",
    tenKRevenue: "Daromad ustasi",
    tenKRevenueDesc: "$10,000+ ishlab topdingiz",
    highRating: "Yuqori baholangan",
    highRatingDesc: "4.8+ reyting va 50+ sharh",
    topInstructor: "Eng yaxshi o'qituvchi",
    topInstructorDesc: "4.5+ reytingni saqlab qoldiring",
    fiftyReviews: "Sharh magniti",
    fiftyReviewsDesc: "50 ta sharh oldingiz",
    perfectScore: "Mukammal ball",
    perfectScoreDesc: "5.0 reytingli kursga ega bo'ling",
    earlyAdopter: "Erta qabul qiluvchi",
    earlyAdopterDesc: "Birinchi oyda qo'shildingiz",
  },
  messages: {
    title: "Xabarlar",
    messages: "Xabarlar",
    ...
    attach: "Biriktirish",
    selectChat: "Xabarlarni ko'rish uchun chatni tanlang",
    ...
    offline: "Oflayn",
    typing: "yozmoqda...",
    unreadMessages: "{count} o'qilmagan xabar",
  },
} as Translations;
