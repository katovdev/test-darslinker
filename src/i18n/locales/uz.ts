...
export const uz: Translations = {
  ...
  auth: {
    ...
    otpSentToTelegram: "Telegramingizga tasdiqlash kodi yuborildi. Kodni olish uchun botni oching.",
    otpResent: "Kod qayta yuborildi!",
    changePhone: "Raqamni o'zgartirish",
    // Registration via Telegram
    registerViaTelegram: "Ro'yxatdan o'tish Telegram bot orqali amalga oshiriladi. Hisob yaratish uchun quyidagi qadamlarni bajaring.",
    telegramBotDescription: "Darslinker rasmiy boti",
    registerStep1: "Telegram botimizni ochish uchun quyidagi tugmani bosing",
    registerStep2: "/start buyrug'ini yuboring va ro'yxatdan o'tish ko'rsatmalariga amal qiling",
